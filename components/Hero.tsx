  ...
  return (
    <div className="relative aspect-square w-full max-w-[460px] mx-auto">
      ...
      >
        ...
        <div className="absolute inset-24 rounded-full border border-onyx/15" />
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[1240px] px-5 sm:px-6 md:px-10 lg:px-14">
        {/* BAND 1 — Photo + name + role + bio + CTAs */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 lg:items-center">
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 0.1, ease }}
            className="lg:col-span-4 mx-auto lg:mx-0 relative w-full max-w-[300px] aspect-[4/5] overflow-hidden rounded-caseLg case-card"
          >
            <Image
              src="/profile.jpeg"
          ...
          <div className="lg:col-span-8">
            ...
            <motion.p
              ...
              className="mt-3 font-display text-lg md:text-xl text-graphite"
            >
              {identity.role}
            </motion.p>
            ...
            <motion.p
              ...
              className="mt-6 max-w-xl text-base md:text-lg text-graphite leading-[1.7]"
            >
              Formée au{" "}
        ...
        {/* BAND 2 — Stats strip, full width */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 0.8 }}
          className="mt-16 md:mt-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-10 md:gap-x-12 gap-y-6 pt-6 border-t border-platinum-line"
        >
          {stats.map((s) => (
            <div key={s.k}>
        ...
        >
          <Dial />
          <blockquote className="italic font-display font-light uppercase tracking-[0.18em] text-sm md:text-base text-graphite text-center">
