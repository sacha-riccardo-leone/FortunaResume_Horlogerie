export const resumeData = {
  meta: {
    ...
    siteDescription:
      "Portrait professionnel de Fortuna Chung, opératrice en horlogerie formée au Pôle Industrie du Locle et expérimentée chez Rolex SA.",
  },
  identity: {
    firstName: "Fortuna",
    lastName: "Chung",
